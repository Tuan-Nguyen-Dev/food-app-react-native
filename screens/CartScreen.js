    ...
    return (
        <View className="bg-white flex-1">
            ...
            <TouchableOpacity
                ...
                className="absolute z-10 rounded-full p-1 shadow top-8 left-2"
            >
            ...
            {/* thời gian nhận hàng ( Delivery Time ) */}
            ...
            <ScrollView
                ...
                className="bg-white pt-5" >
                {
                    Object.entries(groupedItems).map(([key, items]) => {
                        ...
                        return (
                            <View key={key}
                                className="flex-row items-center space-x-3 py-2 px-3 bg-gray-100 rounded-3xl mx-2 mb-3 shadow-2xl"
                            >
